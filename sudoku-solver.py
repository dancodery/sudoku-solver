'''
Daniel Gockel's sudoku solver based on Udacity Artificial Intelligence Nanodegree Course

This Sudoku Agent solves any sudoku and visualizes it in a pretty animation.
The Sudoku is feeded in as a string. 
Each sudoku row is appended to the row before and every unsolved number is replaced by a dot.
Example:
	'..3.2.6..9..3.5..1..18.64....81.29..7.......8..67.82....26.95..8..2.3..9..5.1.3..'

!!!read README.md for instructions running this program!!!
...
def reduce_puzzle(values):
	...
	while not stalled:
		...
		# Apply naked twins: eliminate naked twin digits from peers
...
if __name__ == '__main__':
	...
	for arg in sys.argv:
		if '-h' in arg: # print help
			print("usage: python " + sys.argv[0] + " [--diag] '..3.2.6..9..3.5..1..18.64....81.29..7.......8..67.82....26.95..8..2.3..9..5.1.3..'")
			sys.exit()
		if '-diag' in arg: # diagonal sudokus
			unitlist += diag_units
			diag = True
			print('!!!Solving diagonal Sudoku!!!')
		if len(arg) == 81: # reading sudoku from terminal
			print('reading sudoku from terminal...')
			print("'" + arg + "'")
			sudoku = arg
		print()
	...
	grid_diag = '2.............62....1....7...6..8...3...9...7...6..4...4....8....52.............3'

	if not sudoku:
		print('taking sudoku from samples...')
		if not diag:
			sudoku = grid_easy
		else:
			sudoku = grid_diag
	...
	# Display initial sudoku
	print('Input Grid:')
	display(values)
	print()
	print('Output Solved Grid:')
